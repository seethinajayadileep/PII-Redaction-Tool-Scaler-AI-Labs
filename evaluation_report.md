...
- **Precision:** 1.000  (TP=78, FP=0)
- **Recall:** 1.000  (TP=78, FN=0)
- **F1:** 1.000
- **Accuracy (character-level, mean over scored pages):** 0.986
- **Scored:** true
...
|---|---:|---:|---:|---:|---:|---:|
| address | 1.000 | 1.000 | 1.000 | 7 | 0 | 0 |
| company | 1.000 | 1.000 | 1.000 | 32 | 0 | 0 |
| email | 1.000 | 1.000 | 1.000 | 8 | 0 | 0 |
| name | 1.000 | 1.000 | 1.000 | 26 | 0 | 0 |
...
No false positives or false negatives on the labeled prospectus pages.
